...
![OOPS](https://img.shields.io/badge/OOP-Principles-blue?style=for-the-badge)
...
| :--- | :--- | :--- |
| **🤖 AI_THAT_INVENTS_AI** | An advanced meta-learning framework exploring self-improving algorithms and automated architecture search. | `Gen AI` `AutoML` `Python` |
| **🛰️ Orbital Witness** | A geospatial analysis tool using satellite imagery for object detection and terrain classification. | `Computer Vision` `Deep Learning` |
| **🩺 Breast Cancer Classification** | High-precision medical diagnosis model using **DenseNet-121** to classify malignancy in mammograms. | `PyTorch` `DenseNet` `Medical Imaging` |
